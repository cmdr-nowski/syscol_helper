...
- IF IMPORT NO LONGER WORKS: edit import file, change "phoebe" to "pheobe", "0 truss" to no_truss, "2 truss" to dual_truss and "4 truss" to quad_truss
- IF IT STILL DOESN'T WORK: as per the open issue, construction point cost for small/medium tourist settlements was incorrect. If your build includes these, it may not load now it's fixed. Nothing to be done for this, I'm afraid.
- Undo and redo
